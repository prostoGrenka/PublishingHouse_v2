            ...
            public string username {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'username\' в таблице \'userData\' равно DBNull.", e);
                    }
                }
                set {
            ...
            public string password {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'password\' в таблице \'userData\' равно DBNull.", e);
                    }
                }
                set {
...
namespace PublishingHouse.UserDataSetTableAdapters {
    ...
    public partial class userDataTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[userData] ([username], [password]) VALUES (@username, @passwor" +
                "d);\r\nSELECT id, username, password FROM userData WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[userData] SET [username] = @username, [password] = @password WHERE (([id] = @Original_id) AND ((@IsNull_username = 1 AND [username] IS NULL) OR ([username] = @Original_username)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT id, username, password FROM userData WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PublishingHouse.Properties.Settings.Default.UserConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, username, password FROM dbo.userData";
